...
#define x_min_Pin GPIO_PIN_7
#define x_min_GPIO_Port GPIOA
#define x_plus_Pin GPIO_PIN_0
#define x_plus_GPIO_Port GPIOB
#define y_min_Pin GPIO_PIN_1
#define y_min_GPIO_Port GPIOB
#define y_plus_Pin GPIO_PIN_2
#define y_plus_GPIO_Port GPIOB
